...
- fatty acid synthesis vs degradation
    ...
    - 3. In animals, the enzymes of fatty acid synthesis are components of one long polypeptide chain, the fatty acid synthase, whereas no similar association exists for the degradative enzymes.
...
- 原料&能量
    - Acetyl-CoA
        ...
        - 3. Glycolysis yields cytosolic pyruvate, which is converted to acetyl-CoA by pyruvate dehydrogenase
            cannot cross the mitochondrial membrane
...
- C16 fatty acid synthesis reaction 核心反应
    ...
    - 2. Reduction of the β-Carbonyl Group
        一系列操作删除C=O, 饱和碳链
        ...
        - 与fatty acid degradation in reverse类似, 但有区别
            ...
            - 2. the alcohol formed in biosynthesis has the D-configuration rather than the L-form seen in catabolism
            - 3. the reducing coenzyme is NADPH, whereas NAD+ and FAD+ are the oxidants in the catabolic pathway
    - 3. end
