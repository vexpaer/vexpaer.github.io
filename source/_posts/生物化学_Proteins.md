...
- 结构
    ...
    - Protein Conformation
        - The overall three-dimensional architecture of a protein is generally referred to as its conformation构象.
            This term is not to be confused with configuration构型, which denotes the geometric possibilities for a particular set of atoms.
    - Optical Activity 旋光性 and Stereochemistry 立体化学 of Amino Acids
        - Amino Acids Are Chiral 手性 Molecules
            - Except for glycine, all amino acids have 4 different groups attached to the α-carbon
            - the α-carbon is said to be asymmetric or chiral
            - the two possible configurations for the α-carbon constitute enantiomers 旋光对映体
        - D/L - Configurations
    ...
    - Separation methods based on size
        ...
        - dialysis and ultrafiltration 透析与超滤
            ...
            - ultrafiltration
                ...
                - This technique is useful for concentrating dilute solutions of macro molecules.
                    这种技术可用于浓缩稀的大分子溶液
                - The concentrated protein can then be diluted into the solution of choice.
                    之后还能将浓缩后的蛋白质稀释到所需溶液中
    - Separation methods based on electrical charge
        - solubility 溶解性
            ...
            - Ionic strength
                ...
                - However,as the salt concentration reaches high levels (greater than 1 M),the effect may reverse so that the protein is salted out 盐析 of solution.
        - electrophoresis 电泳
            - Isoelectric Focusing IEF 等电聚焦
                - 按电荷分离
                - 用两性电解质形成从酸性到碱性的连续 pH 梯度，蛋白质会在电场中迁移，直到到达与其等电点 (pI) 一致的 pH 位置，此时蛋白质净电荷为零，停止移动
            - SDS-Polyacrylamide Gel Electrophoresis (SDS-PAGE) SDS - 聚丙烯酰胺凝胶电泳
                - 按质量分离
    ...
    - Purification of Protein Mixtures
        ...
        - A Typical Protein Purification Scheme
            ...
            - 参数
                ...
                - 总蛋白 - 每一步样品中总蛋白质的含量，随着纯化进行，总蛋白逐渐减少，说明杂质被去除
                - 总活性 - 每一步样品中黄嘌呤脱氢酶的总催化活性，纯化过程中总活性下降，是因为部分酶可能在操作中失活或被丢弃
                - 比活性 - 总活性与总蛋白的比值，是判断纯度的核心指标。从粗提物的 0.108 到免疫亲和层析后的 152，比活性大幅上升，说明黄嘌呤脱氢酶在总蛋白中的占比越来越高，纯度不断提升
                - 回收率 - 每一步总活性与粗提物总活性的百分比，体现酶的得率
- Amino Acid Analysis of Proteins
    - Amino Acid Analysis of Proteins by amino acid analyzers
...
- Determining the Primary Structure of a Protein
    ...
    - 测定氨基酸序列步骤
        ...
        - 2. Intrachain S-S (disulfide) cross-bridges between cysteine residues in the polypeptide chain are cleaved.
            If these disulfides are interchain linkages, then step 2 precedes step 1 若这些二硫键为链间连接键，则步骤 2 需在步骤 1 之前进行
        - 3. The N-terminal and C-terminal residues are identified.
        - 4. Each polypeptide chain is cleaved into smaller fragments, and the amino acid composition and sequence of each fragment are determined.
        - 5. Step 4 is repeated, using a different cleavage procedure to generate a different and therefore overlapping set of peptide fragments.
            重复步骤 4，但采用不同的切割方法，以生成一组不同且存在重叠的肽片段
        - 6. The overall amino acid sequence of the protein is reconstructed from the sequences in overlapping fragments.
            根据重叠片段的序列，重建出蛋白质的完整氨基酸序列
    - 步骤3
        - N-Terminal Analysis
            - The amino acid residing at the N-terminal end of a protein can be identified in a number of ways
            - Edman degradation
        ...
        - C-Terminal Analysis
            ...
            - Carboxypeptidases are enzymes that cleave amino acid residues from the C-termini of polypeptides in a successive fashion
                羧肽酶是一类能从多肽 C - 末端连续切割氨基酸残基的酶
            - Several carboxy peptidases are in general use - A, B, and Y
                目前常用的羧肽酶主要有三种：A 型、B 型和 Y 型
    - 步骤4
...
- Some Proteins Have Chemical Groups Other Than Amino Acids
    - The general term for proteins containing nonprotein constituents is conjugated proteins
    - If the nonprotein part participates in the protein’s function, it is referred to as a prosthetic group 辅基
    - Conjugation of proteins with these different nonprotein constituents dramatically enhances the repertoire of functionalities available to proteins.
        蛋白质与这些不同非蛋白质组分的结合，会显著拓展蛋白质所能具备的功能范围
    - common conjugated proteins 缀合蛋白质
        - glycoproteins 糖蛋白
            - contain carbohydrate
            - Proteins destined for an extracellular location are characteristically glycoproteins
                注定要定位到细胞外的蛋白质，其典型特征是它们属于糖蛋白
            - Many membrane proteins are glycosylated on their extracellular segments
        - lipoproteins 脂蛋白
            - Blood plasma lipoproteins
                - prominent examples of the class of proteins conjugated with lipid
                - function primarily in the transport of lipids to sites of active membrane synthesis
                    主要功能是将脂质运输到膜合成活跃的部位
            - Serum levels of low density lipoproteins (LDLs) are often used as a clinical index of susceptibility to vascular disease
                血清中的低密度脂蛋白（LDL）水平，常被用作评估个体患血管疾病易感性的临床指标
        - nucleoproteins 核酸蛋白
            - roles in the storage and transmission of genetic information
                在遗传信息的储存和传递中发挥着多种作用
            - Virus, chromosomes, ribosomes are protein–nucleic acid complexes
                病毒, 染色体, 核糖体都是蛋白-核酸复合物
        - phosphoproteins 磷蛋白
            - These proteins have phosphate groups esterified to the hydroxyls of serine, threonine, or tyrosine residues.
                这些蛋白质的丝氨酸、苏氨酸或酪氨酸残基的羟基上，均结合有通过酯键连接的磷酸基团
            - Casein, the major protein of milk, contains many phosphates
                酪蛋白是牛奶中的主要蛋白质，它含有大量磷酸基团，能为发育中的婴儿提供必需的磷元素
        - metalloproteins 金属蛋白
            - 2种作用
                - metal storage forms, as in the case of ferritin 铁蛋白
                - enzymes in which the metal atom participates in a catalytically important manner
            - hemoproteins 血红蛋白
...
- Biological Functions
    ...
    - Regulatory Proteins
        - do not perform any obvious chemical transformation but nevertheless can regulate the ability of other proteins to carry out their physiological functions
        - Protein hormone 激素
            - Insulin 胰岛素
                - regulating glucose metabolism in animals
            - Adiponectin 脂联素
            ...
            - Leptin 瘦素
                ...
                - including appetite/hunger and metabolism
                - It is one of the most important adipose脂肪-derived hormones激素
        - Transcriptional factors 转录因子
            - 指能够结合在某基因上游特异核苷酸序列上的蛋白质，这些蛋白质能调控其基因的转录
    - Transport Proteins
    ...
    - Storage Proteins
        - Ovalbumin 卵清蛋白
            ...
            - provides the developing bird embryo with a source of nitrogen
        - Casein酪蛋白
            - the most abundant protein of milk
            - the major nitrogen source for mammalian infants
    - Contractile and Motile Proteins 收缩和运动蛋白
        - filamentous or polymerize to form filaments
            都是呈丝状的，或能聚合形成丝状体
        - 比如 actin, myosin, tubulin,
    ...
    - Protective and Exploitive Proteins
        ...
        - immunoglobulins 免疫球蛋白 or antibodies 抗体
            - produced by the lymphocytes of vertebrates
            - can specifically recognize and neutralize “foreign” molecules resulting from the invasion of the organism by bacteria, viruses, or other infectious agents
        - thrombin 凝血酶 and fibrinogen 纤维蛋白原
            - the blood-clotting proteins
            - prevent the loss of blood when the circulatory system is damaged
        - Green fluorescent protein (GFP)
            - from Jellyfish to Gene Expression and Protein Targeting
