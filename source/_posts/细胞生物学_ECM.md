...
amino sugar氨基糖 与 uronic acid糖醛酸 重复
...
1. GAGs tend to adopt highly extended conformations that occupy a huge volume relative to their mass 善于填充整个空间
...
大部分GAGs与core protein结合形成proteoglycan  

core protein在endoplasmic reticulum内质网形成  
Polysaccharide chains are assembled on this core protein in the Golgi apparatus
...
strengthen and help organize the matrix, and give matrix resilience弹性

## collagen 胶原蛋白

The major proteins of the ECM, constituting 25% of the total protein mass  
...
gives tissues the resilience to recoil after transient stretch
...
1. Contribute to both organizing the matrix and helping cells attach to it
2. Guide cell movements in developing tissues
3. Bind and influence the function of peptide肽 growth factors and other small molecules

## Fibronectin(FN) 纤维粘蛋白
...
A specialized type of extracellular matrix

Functions
- separates cells from underlying or surrounding connective tissue
- forms the mechanical connection lies between two cell sheets
