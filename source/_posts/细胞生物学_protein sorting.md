...
Signal peptidase (信号肽酶)  
ER luminal腔内 proteolytic水解 enzyme,专门切掉并降解信号肽
...
3. translocon 移位子 transfers the growing polypeptide chain across the ER membrane
4. SRP dissociate from the signal sequence and ribosome, returns to the cytoplasmic matrix for reuse
...
1. Transmembrane transport (蛋白质的跨膜转运)  
...
in the post-translational transport pathway

外膜上有个TOM complex  
内膜上有个TIM complex  

有三种去处
1. Protein Sorting from Cytoplasmic Matrix to Mitochondrial Matrix 到最里面
2. Protein Sorting from Cytoplasmic Matrix to the Mitochondrial Inner Membrane 到内膜
